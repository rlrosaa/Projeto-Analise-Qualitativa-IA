...
public class Constantes {
    ...
    public static final String URL_BASE_API_GPT = "https://api.openai.com/v1/chat/completions";
    public static final String TOKEN_GPT = "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";

    public static final String URL_BASE_API_GEMINI = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent";
    public static final String TOKEN_GEMINI = "AIzaSyDynKHtN6_u37GlWV74h2cCP0s-x5yDVxI";

    public static final String URL_BASE_API_CLAUDE = "https://api.anthropic.com/v1/messages";
